    ...
    <div className="topo flex min-h-[100dvh] flex-col items-center justify-center px-5">
      <div className="w-full max-w-sm">
        ...
        <button
          ...
          className="hud mt-6 flex w-full items-center justify-center gap-2 rounded-sm border border-border bg-card py-3.5 text-xs text-foreground disabled:opacity-40"
        >
          {googleLoading ? (
        ...
        <div className="my-4 flex items-center gap-3">
          ...
          <span className="hud text-[9px] text-muted-foreground">OR</span>
          <div className="h-px flex-1 bg-border" />
        </div>
        ...
        <form onSubmit={handleSubmit} className="space-y-3">
          <input
            ...
            required
            className="hud w-full rounded-sm border-2 border-paper-foreground/20 bg-transparent px-3 py-2.5 text-sm text-paper-foreground outline-none focus:border-paper-foreground/60"
          />
          <input
            type="password"
            value={password}
