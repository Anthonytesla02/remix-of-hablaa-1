...
export const Route = createFileRoute("/start")({
  head: () => ({
    meta: [
      { title: "Set up your course — Habla" },
      {
        name: "description",
        content:
          "Pick your language, choose the tutor who teaches you and set a daily goal you can actually keep.",
      },
      { property: "og:title", content: "Set up your course — Habla" },
      {
        property: "og:description",
        content: "Three minutes of setup and you start speaking today.",
      },
